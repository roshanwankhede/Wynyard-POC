...
<div id="upright">
	...
	<div id=page_id style="margin-top: 20px">
	<div id="page_selection_id" style="margin-top: 20px">
		<label><b style="font-size: 16">Number of Result:</b></label><br>
	</div>
	<select id="page_no" style="margin-top: 10px">
